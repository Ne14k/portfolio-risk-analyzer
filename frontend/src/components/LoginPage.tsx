...
import { isValidEmail, formatAuthError } from '../services/auth';
...
export function LoginPage({ isDark, onThemeToggle }: LoginPageProps) {
  ...
  // Set page title
  useEffect(() => {
    document.title = 'MyPortfolioTracker - Login';
  }, []);
  ...
  const handleInputChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (validationErrors[name as keyof LoginFormErrors]) {
